...
Secrets, such as database passwords, internal host names, and private keys are 
a key part of security systems.  Unfortunately, secrets are hard to securely 
distribute, rotate, and revoke, especially in distributed systems like
microservices.

To address these issues, a technique called Docker secrets has been developed.
Docker secrets automatically provisions containers with secrets without
...
requiring application modification to call a custom API.  Additionally, 
